...
CREATE TABLE IF NOT EXISTS `User` (
  ...
  `password` varchar(50) COLLATE utf8_unicode_ci DEFAULT '',
  `headimgUrl` varchar(100) COLLATE utf8_unicode_ci DEFAULT '',
  `adress` varchar(50) COLLATE utf8_unicode_ci DEFAULT '',
  `sex` varchar(50) COLLATE utf8_unicode_ci DEFAULT '',
  `school` varchar(50) COLLATE utf8_unicode_ci DEFAULT '',
